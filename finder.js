...
const Finder = Module("finder", {
    ...
    function (str) {
        ...
        //Meh
        commandline.echo("mm", commandline.HL_WARNINGMSG, commandline.APPEND_TO_MESSAGES | commandline.FORCE_SINGLELINE);
        if (result == Ci.nsITypeAheadFind.FIND_NOTFOUND) {
            //commandline.echo("Not foundy", commandline.HL_WARNINGMSG, commandline.FORCE_MULTILINE);
            //liberator.echoerr("Pattern not found: " + this._searchString, commandline.FORCE_MULTILINE);
            commandline.echo("m", commandline.HL_WARNINGMSG, commandline.APPEND_TO_MESSAGES | commandline.FORCE_MULTILINE);
        }
        //esle
         //   commandline.echo("", commandline.FORCE_SINGLELINE);
